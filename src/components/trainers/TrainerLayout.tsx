...
const TrainerLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen flex md:flex-row bg-slate-100">
        ...
        <section className="bg-gradient-to-r from-white to-white py-2 px-4 flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={notificationRef}>
              <BsBell
                className="h-5 w-5 sm:h-6 sm:w-6 cursor-pointer text-[#572c52]"
            ...
            <div className="relative" ref={profileRef}>
              <FaUserCircle
                className="text-xl sm:text-2xl cursor-pointer text-[#572c52]"
